...
class ConduitAppTestChannel extends ApplicationChannel
  ...
  Future prepare() async {
    ...
    final config = ConduitAppTestConfiguration(options!.configurationFilePath!);
...
class ConduitAppTestConfiguration extends Configuration {
  ConduitAppTestConfiguration(String fileName) : super.fromFile(File(fileName));
